...
abstract class BasesfGuardUserForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'zone_id'          => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('ShippingZone'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'zone_id'          => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('ShippingZone'), 'required' => false)),
      'profile_image'    => new sfValidatorString(array('max_length' => 255, 'required' => false)),
      'fb_user_id'       => new sfValidatorInteger(array('required' => false)),
      'twitter_user_id'  => new sfValidatorInteger(array('required' => false)),
