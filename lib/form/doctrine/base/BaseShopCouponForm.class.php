...
/**
 * ShopCoupon form base class.
 *
 * @method ShopCoupon getObject() Returns the current form's model object
 *
 * @package    sf_sandbox
 * @subpackage form
 ...
 */
abstract class BaseShopCouponForm extends BaseFormDoctrine
{
  public function setup()
  {
    $this->setWidgets(array(
      ...
      'user_id'    => new sfWidgetFormDoctrineChoice(array('model' => $this->getRelatedModelName('CouponCustomer'), 'add_empty' => true)),
    ...
    $this->setValidators(array(
      ...
      'user_id'    => new sfValidatorDoctrineChoice(array('model' => $this->getRelatedModelName('CouponCustomer'), 'required' => false)),
    ...
    $this->widgetSchema->setNameFormat('shop_coupon[%s]');
