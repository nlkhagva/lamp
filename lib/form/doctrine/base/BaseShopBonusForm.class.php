...
/**
 * ShopBonus form base class.
 *
 * @method ShopBonus getObject() Returns the current form's model object
 *
 * @package    sf_sandbox
 * @subpackage form
 ...
 */
abstract class BaseShopBonusForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('shop_bonus[%s]');
