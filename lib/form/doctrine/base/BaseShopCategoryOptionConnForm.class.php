...
/**
 * ShopCategoryOptionConn form base class.
 *
 * @method ShopCategoryOptionConn getObject() Returns the current form's model object
 *
 * @package    sf_sandbox
 * @subpackage form
 ...
 */
abstract class BaseShopCategoryOptionConnForm extends BaseFormDoctrine
{
  public function setup()
  {
    ...
    $this->widgetSchema->setNameFormat('shop_category_option_conn[%s]');
