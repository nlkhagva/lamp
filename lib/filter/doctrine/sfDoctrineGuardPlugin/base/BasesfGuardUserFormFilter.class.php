...
abstract class BasesfGuardUserFormFilter extends BaseFormFilterDoctrine
{
  public function setup()
  {
    ...
    $this->setValidators(array(
      ...
      'zone_id'          => new sfValidatorDoctrineChoice(array('required' => false, 'model' => $this->getRelatedModelName('ShippingZone'), 'column' => 'id')),
      'profile_image'    => new sfValidatorPass(array('required' => false)),
      'fb_user_id'       => new sfValidatorSchemaFilter('text', new sfValidatorInteger(array('required' => false))),
