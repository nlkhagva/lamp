...
<div class="breadcrumbs" id="breadcrumbs">
    ...
    <ul class="breadcrumb">
        ...
        <li class="active">[?php echo <?php echo $this->getI18NString('list.title') ?> ?]</li>
    </ul>
...
<div class="page-content">
  ...
  <?php if ($this->configuration->hasFilterForm()): ?>
    [?php $filterValues = $sf_user->getAttribute('<?php echo $this->getModuleName() ?>.filters', array(), 'admin_module'); if (!empty($filterValues)): ?]
