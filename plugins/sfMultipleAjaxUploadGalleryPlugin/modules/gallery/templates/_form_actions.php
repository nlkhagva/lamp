<div class="form-actions">
    <div class="btn-group">
        ...
        <?php else: ?>
            ...
            <?php else: ?>
                <?php echo link_to(__('backend.action.edit.purge',array(),"sfmaug"), 'gallery/purge?id='.$gallery->getId(), array('class' => 'btn btn-warning',  'confirm' => __('backend.action.edit.purge.confirmation',array(),"sfmaug"))) ?>
            <?php endif; ?>
