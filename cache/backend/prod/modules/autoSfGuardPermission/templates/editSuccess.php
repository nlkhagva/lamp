...
<div class="breadcrumbs" id="breadcrumbs">
    ...
    <ul class="breadcrumb">
        ...
        <li class="active"><?php echo __('\"%%name%%\"', array('%%name%%' => $sf_guard_permission->getName()), 'messages') ?></li>
    </ul>

</div>
<div class="page-content">
  <div class="page-header">
    <h1><?php echo __('\"%%name%%\"', array('%%name%%' => $sf_guard_permission->getName()), 'messages') ?></h1>
  </div>
