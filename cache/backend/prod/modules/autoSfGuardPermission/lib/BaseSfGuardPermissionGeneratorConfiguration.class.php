...
abstract class BaseSfGuardPermissionGeneratorConfiguration extends sfModelGeneratorConfiguration
{
  ...
  {
    return array(  0 => 'name',  1 => 'description',  2 => 'groups_list',  3 => 'users_list',);
  }
  ...
  public function getFieldsDefault()
  {
    return array(
      ...
      'name' => array(  'is_link' => false,  'is_real' => true,  'is_partial' => false,  'is_component' => false,  'type' => 'Text',  'label' => 'Нэр',),
      'description' => array(  'is_link' => false,  'is_real' => true,  'is_partial' => false,  'is_component' => false,  'type' => 'Text',  'label' => 'Тайлбар',),
      'created_at' => array(  'is_link' => false,  'is_real' => true,  'is_partial' => false,  'is_component' => false,  'type' => 'Date',  'label' => 'Үүссэн огноо',),
      'updated_at' => array(  'is_link' => false,  'is_real' => true,  'is_partial' => false,  'is_component' => false,  'type' => 'Date',  'label' => 'Засварласан огноо',),
      'groups_list' => array(  'is_link' => false,  'is_real' => false,  'is_partial' => false,  'is_component' => false,  'type' => 'Text',  'label' => 'Группууд',),
      'users_list' => array(  'is_link' => false,  'is_real' => false,  'is_partial' => false,  'is_component' => false,  'type' => 'Text',  'label' => 'Хэрэглэгчид',),
    );
  }
