...
<?php #include_partial('sfGuardGroup/navbar', array('filter' => 1)) ?>
<div class="breadcrumbs" id="breadcrumbs">
    ...
    <ul class="breadcrumb">
        ...
        <li class="active"><?php echo __('Групп жагсаалт', array(), 'messages') ?></li>
    </ul>

</div>
<div class="page-content">

      <?php $filterValues = $sf_user->getAttribute('sfGuardGroup.filters', array(), 'admin_module'); if (!empty($filterValues)): ?>
  ...
  <div class="page-header">
    ...
    <h1><?php echo __('Групп жагсаалт', array(), 'messages') ?>
