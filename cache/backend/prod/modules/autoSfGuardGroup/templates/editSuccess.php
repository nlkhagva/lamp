...
<div class="breadcrumbs" id="breadcrumbs">
    ...
    <ul class="breadcrumb">
        ...
        <li class="active"><?php echo __(' "%%name%%" групп засах', array('%%name%%' => $sf_guard_group->getName()), 'messages') ?></li>
    </ul>

</div>
<div class="page-content">
  <div class="page-header">
    <h1><?php echo __(' "%%name%%" групп засах', array('%%name%%' => $sf_guard_group->getName()), 'messages') ?></h1>
  </div>
