...
<?php #include_partial('sfGuardUser/navbar', array('filter' => 1)) ?>
<div class="breadcrumbs" id="breadcrumbs">
    ...
    <ul class="breadcrumb">
        ...
        <li class="active"><?php echo __('Хэрэглэгчид', array(), 'messages') ?></li>
    </ul>

</div>
<div class="page-content">

      <?php $filterValues = $sf_user->getAttribute('sfGuardUser.filters', array(), 'admin_module'); if (!empty($filterValues)): ?>
  ...
  <div class="page-header">
    ...
    <h1><?php echo __('Хэрэглэгчид', array(), 'messages') ?>
