...
<div class="breadcrumbs" id="breadcrumbs">
    ...
    <ul class="breadcrumb">
        ...
        <li class="active"><?php echo __('Хэрэглэгчийн мэдээлэл засах "%%username%%"', array('%%username%%' => $sf_guard_user->getUsername()), 'messages') ?></li>
    </ul>

</div>
<div class="page-content">
  <div class="page-header">
    <h1><?php echo __('Хэрэглэгчийн мэдээлэл засах "%%username%%"', array('%%username%%' => $sf_guard_user->getUsername()), 'messages') ?></h1>
  </div>
