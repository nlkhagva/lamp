...
<div id="filterPopup" class="modal hide fade">
  ...
  <form action="<?php echo url_for('sf_guard_user_collection', array('action' => 'filter')) ?>" method="post" class="form-horizontal">
    ...
    <div class="modal-footer">
      ...
      <?php echo link_to(__('Reset', array(), 'sf_admin'), 'sf_guard_user_collection', array('action' => 'filter'), array('query_string' => '_reset', 'method' => 'post', 'class' => 'btn')) ?>
    </div>
