...
require_once(dirname(__FILE__).'/../lib/BaseVideoGeneratorConfiguration.class.php');
require_once(dirname(__FILE__).'/../lib/BaseVideoGeneratorHelper.class.php');
 ...
 */
abstract class autoVideoActions extends sfActions
{
