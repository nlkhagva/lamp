...
<?php #include_partial('video/navbar', array('filter' => 1)) ?>
<div class="breadcrumbs" id="breadcrumbs">
    ...
    <ul class="breadcrumb">
        ...
        <li class="active"><?php echo __('Видео жагсаалт', array(), 'messages') ?></li>
    </ul>

</div>
<div class="page-content">

      <?php $filterValues = $sf_user->getAttribute('video.filters', array(), 'admin_module'); if (!empty($filterValues)): ?>
  ...
  <div class="page-header">
    ...
    <h1><?php echo __('Видео жагсаалт', array(), 'messages') ?>
